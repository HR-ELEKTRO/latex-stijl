...
\NewDocumentCommand \langetabel {mmmmmm} 
{
	...
	{\centering%
		...
		\begin{longtable}{|#3|}
			...
			\seq_use:Nn \l_tmpb_seq {&} \\\hline
			\endhead
			\multicolumn{#6}{r}{\sffamily\small Deze~tabel~wordt~vervolgd~op~de~volgende~pagina.}\\
			\endfoot
			\hline
			\endlastfoot
			#5 
...
\NewDocumentCommand \langetabelX {O{\textwidth}mmmmmm} 
{
	{\centering%
		...
		\begin{xltabular}{#1}{|#4|}
			...
			\seq_use:Nn \l_tmpb_seq {&} \\\hline
			\endhead
			\multicolumn{#7}{r}{\sffamily\small Deze~tabel~wordt~vervolgd~op~de~volgende~pagina.}\\
			\endfoot
			\hline
			\endlastfoot
			#6
