...
\newcommand{\versiehistoryheader}{%
    \rowfont[c]{\bfseries\rmfamily\color{white}}\rowcolor{red} Datum & Versie & Omschrijving & Auteur
    \\ \hline
}
\newcommand{\versiehistorie}[1]{
    \section*{Versiehistorie}
	\begin{longtabu}{|ccX[jm]c|}
        \taburulecolor{red}
        \hline
        \versiehistoryheader
        \endfirsthead
...
\newcommand{\tabel}[6][!htbp]{
    \begin{myTable}[#1]
        ...
        \begin{tabu}{|#4|}
            \taburulecolor{red}
            \hline
            \rowfont[c]{\bfseries\rmfamily\color{white}}\rowcolor{red} #5\\ \hline
            #6\\ \hline
        \end{tabu}
    \end{myTable}
}
