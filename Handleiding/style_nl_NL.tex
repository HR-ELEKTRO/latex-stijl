...
\newcommand{\versiehistoryheader}{%
    \rowfont[c]{\bf\color{white}}\rowcolor{red} Datum & Versie & Omschrijving & Auteur
    \\ \hline
}
...
\newcommand{\tabel}[6][!htbp]{
    \begin{myTable}[#1]
        ...
        \begin{tabu}{|#4|}
            \taburulecolor{red}
            \hline
            \rowfont[c]{\bf\color{white}}\rowcolor{red} #5\\ \hline
            #6\\ \hline
        \end{tabu}
    \end{myTable}
}
...
\newcommand{\myfancy}{
    ...
    \ifboolexpr{togl {ebook} or togl {onesided}}{
        \fancyhead[L]{\headerfont\module@code@box{}} 
		...
		\expandafter\ifstrequal\expandafter{\myClass}{article}{
	        \fancyhead[OR]{\headerfont\nouppercase{\rightmark}\hspace{1em}\module@code@box{}} 
	        \fancyhead[EL]{\headerfont\module@code@box{}\hspace{1em}\nouppercase{\rightmark}}         
		}{
        \fancyhead[OR]{\headerfont\nouppercase{\leftmark}\hspace{1em}\module@code@box{}} 
        \fancyhead[EL]{\headerfont\module@code@box{}\hspace{1em}\nouppercase{\leftmark}}         
		}
