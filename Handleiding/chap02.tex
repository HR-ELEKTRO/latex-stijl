...
De \enquote{stijl} van het document wordt bepaald in de preamble en is in een apart bestand geplaatst genaamd |style_nl_NL.tex|.
...
Als je in de het dictaat onderscheid wilt maken tussen de ebook en de papieren versie, dan kan dat door gebruik te maken van |\iftoggle{ebook}|.
De code:
...
De class article kun je gebruiken voor eenvoudige documenten zoals bijvoorbeeld een modulewijzer%
\footnote{%
	Zie: \href{https://bitbucket.org/HR_ELEKTRO/tds02/downloads/Modulewijzer_TDS02.pdf}{Modulewijzer\_TDS02.pdf} en 
...
Dit commando maakt gebruik van de commando's |\modulecode|, |\titel|, \hcode[style=lstyle]{\\docu\\-ment\\-type}, |\huidigeversie| en |\auteurs|.
Het logo (\hcode{./figs/\\-logo\\-HR.png}) en vervagende logo \hcode{./figs/\\-logo\\-HR\\-fade\\-top.png}) zijn hard gecodeerd in de stijl maar kunnen daar natuurlijk wel aangepast worden.
...
Bijvoorbeeld de zin: heel heel erg veel data-elementen data-elementen data-elementen data-elementen data-elementen en data-elementen data-elementen data-elementen
data-elementen data-elementen data-elementen data-elementen data-elementen en data-elementen wordt \enquote{vreemd} afgebroken.
...
Bijvoorbeeld de zin: heel heel erg veel data\hyp{}elementen data\hyp{}elementen data\hyp{}elementen data\hyp{}elementen data\hyp{}elementen en 
...
Het \lcode{\\figuur} commando heeft dus de volgende vorm: \hcode{\\figuur\[arg1\]\{arg2\}\{arg3\}\{arg4\}}.} is.
...
De filenaam wordt ook als deel van het label gebruikt: het label wordt |fig:filenaam|.
...
Dit is een zeer uitgebreide package met een vrij steile leercurve.
...
De tikzlibraries |fadings| en |shadows| worden daar ook in gebruikt maar overige tikzlibraries moet je zelf opnemen in de preamble van je document.
De code die gegeven is in \cref{lst:tikzvoorbeeld} produceert het blokdiagram dat in \cref{fig:dsp} is weergegeven.
In de code wordt gebruik gemaakt van de environment |myFigure| die in de stijl is gedefinieerd en niet van de standaard environment |figure| 
zodat de witruimte aangepast wordt overeenkomstig de met het commando |figuur| aangemaakte figuren.
...
Deze package bouwt weer voort op |tikz|.
...
|\tabel|, |\tabelmaxpaginabreedgeschaald| en \hcode{\\lan\\-ge\\-ta\\-bel}.
...
De eerste parameter bevat de \squote{placement} argumenten voor de |\table| environment.
De default waarde is |!htbp|.
De tweede parameter is de titel van de tabel.
De derde parameter is een deel van het label, de labelnaam wordt |tab:derde-argument|.
...
Het enige verschil is dat het commando \hcode[style=lstyle]{\\tabel\\-max\\-pa\\-gina\\-breed\\-ge\\-schaald} de tabel zodanig schaalt dat hij de volledige tekstbreedte van de pagina benut.
...
De verwijzingen naar een tabel, figuur enz.\ maak ik met |\cref{label}|, de tekst tabel, figuur enz.\ wordt er dan vanzelf bijgezet en dit wordt ook onderdeel van de link.
Bijvoorbeeld de code |\cref{tab:zomaar}| geeft: \cref{tab:zomaar}.
...
Bijvoorbeeld de code |\csecref{sec:inleiding}| geeft: \cref{sec:inleiding} in de ebook versie en \cref{sec:inleiding} (\cpageref{sec:inleiding}) in de papieren versie.
...
Als de URL ook in de biblatex informatie is opgenomen dan is het eenvoudiger om het command |\citepdfdeel| gebruikt worden.
...
Je kunt vanuit de tekst verwijzen naar deze opdracht met de code |\cref{opdr:opdracht}|.
...
Als een ebook wordt gemaakt (door het commando |\ebooktrue| in |args.tex| te plaatsen), dan levert de code \hcode{\\hand\\-te\\-ken\\-ing} geen kader op.
De code \hcode{\\hand\\-te\\-ken\\-ing\{\}} levert in een ebook de volgende tekst op:
