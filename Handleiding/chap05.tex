...
\begin{itemize}
    \item Als de \LaTeX{}-code in een VCS wordt opgenomen worden alle wijzigingen en contributies netjes bijgehouden.
    ...
    \item De pdf bestanden die met \LaTeX{} gegenereerd worden kunnen gepubliceerd worden in het Downloads directory van de repository.
        Het zou handig zijn als dit automatisch gedaan zou kunnen worden met een make commando.
        Zodra ik tijd heb zal ik dit proberen te implementeren.
    \item Het is handig om na elke zin een enter in te typen.
