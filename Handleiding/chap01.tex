...
\begin{itemize}
\item \citetitle{dcs01} \cite{dcs01} (Nederlands).\footnote{Zie: \url{https://bitbucket.org/HR_ELEKTRO/dcs01/downloads/Collegedictaat_DCS01.pdf} en \url{https://bitbucket.org/HR_ELEKTRO/dcs01/downloads/Collegedictaat_DCS01_ebook.pdf}. De sourcecode vind je hier: \url{https://bitbucket.org/HR_ELEKTRO/dcs01/}.}
\item \citetitle{tds02} \cite{tds02} (Engels).\footnote{Zie: \url{https://bitbucket.org/HR_ELEKTRO/tds02/downloads/Lab_Work_Handbook_TDS02.pdf} en \url{https://bitbucket.org/HR_ELEKTRO/tds02/downloads/Lab_Work_Handbook_TDS02_ebook.pdf}. De sourcecode vind je hier: \url{https://bitbucket.org/HR_ELEKTRO/tds02/}.}
...
\begin{itemize}
\item Modulewijzer TDS02 (Nederlands).\footnote{Zie: \url{https://bitbucket.org/HR_ELEKTRO/tds02/downloads/Modulewijzer_TDS02.pdf} en \url{https://bitbucket.org/HR_ELEKTRO/tds02/downloads/Modulewijzer_TDS02_ebook.pdf}. De sourcecode vind je hier: \url{https://bitbucket.org/HR_ELEKTRO/tds02/}.}
\item Report Requirements for TDS02 (Engels).\footnote{Zie: \url{https://bitbucket.org/HR_ELEKTRO/tds02/downloads/Report_Requirements_TDS02.pdf} en \url{https://bitbucket.org/HR_ELEKTRO/tds02/downloads/Report_Requirements_TDS02_ebook.pdf}. De sourcecode vind je hier: \url{https://bitbucket.org/HR_ELEKTRO/tds02/}.}
\end{itemize} 
